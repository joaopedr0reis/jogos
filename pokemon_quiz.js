...
const Perguntas = [{
    id: 0,
    q: "Qual foi o primeiro pokemon que o Ash conseguiu?",
    a: [{ text: "charmander", estaCorreto: false },
        { text: "Mewtwo", estaCorreto: false },
        { text: "Pikachu", estaCorreto: true },
        { text: "Bulbasaur", estaCorreto: false }
    ]

},
{
    id: 1,
    q: "Quais são as 3 aves lndarios?",
    a: [{ text: "Caterpie, Vivilon, Beedrill", estaCorreto: false, isSelected: false },
        { text: "Pidgey, Charizard, Snorlax ", estaCorreto: false },
        { text: "gyarados, Slowbro, Lapras", estaCorreto: false },
        { text: "Articuno, Zapdos, Moltres", estaCorreto: true }
    ]

},
{
    id: 2,
    q: "Qual a tipagem do kyogre?",
    a: [{ text: "Metal", estaCorreto: false },
        { text: "Terra", estaCorreto: false },
        { text: "Agua", estaCorreto: true },
