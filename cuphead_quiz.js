...
const Perguntas = [{
    id: 0,
    q: "Quantos personagens os players podem controlar?",
    a: [{ text: "5", estaCorreto: false },
        { text: "3", estaCorreto: false },
        { text: "2", estaCorreto: true },
        { text: "8", estaCorreto: false }
    ]
...
},
{
    id: 1,
    q: "Qual o boss final?",
    a: [{ text: "Rei Dado", estaCorreto: false, isSelected: false },
        { text: "Capeta", estaCorreto: false },
        { text: "Vegetais", estaCorreto: false },
        { text: "Diabo", estaCorreto: true }
    ]

},
{
    id: 2,
    q: "Qual o primeiro boss que você usa o avião?",
    a: [{ text: "Dragao", estaCorreto: false },
        { text: "Vegetais", estaCorreto: false },
        { text: "Joaninha", estaCorreto: true },
        { text: "Flor", estaCorreto: false }
    ]
